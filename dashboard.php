                ...
                <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                        ...
                        <li class="mx-3 welcome-text">
                            <h3 class="mb-0 fw-bold text-truncate"><?php echo $greeting; ?> and Welcome !</h3>
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                                ...
                                <div class="ms-0" style="max-height:230px;" data-simplebar>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="All" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                                            ...
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13">Your Unpaid clicks are</h6>
                                                        <small class="text-muted mb-0"><?php echo $total_clicks; ?></small>
                                                    </div><!--end media-body-->
                                                </div><!--end media-->
                                            </a><!--end-item-->
                                            <!-- item-->
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        ...
                                                        <small class="text-muted mb-0"><?php echo number_format($total_amount_earned, 2); ?></small>
                                                    </div><!--end media-body-->
                                                </div><!--end media-->
                                            </a><!--end-item-->
                                            <!-- item-->
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13"><?php echo $daily_clicks; ?> continue watching ads</h6>
                                            ...
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        ...
                                                        <small class="text-muted mb-0">Pesist, you can from <?php echo number_format($total_amount_earned, 2); ?> and elevate to target</small>
                                                    </div><!--end media-body-->
                                                </div><!--end media-->
                                            </a><!--end-item-->
                                        </div>
                                        <div class="tab-pane fade" id="Projects" role="tabpanel" aria-labelledby="projects-tab" tabindex="0">
                                            ...
                                            <!-- item-->
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                <small class="float-end text-muted ps-2">Thankyou for trusting gainly</small>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">
                                                        <i class="iconoir-user fs-4"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-2 text-truncate">
                                                        <h6 class="my-0 fw-normal text-dark fs-13">Thanks from Gainly</h6>
                                        ...
                                        <div class="tab-pane fade" id="Teams" role="tabpanel" aria-labelledby="teams-tab" tabindex="0">
                                            <!-- item-->
                                            <a href="dark-ecommerce-index.html#" class="dropdown-item py-3">
                                                <small class="float-end text-muted ps-2">Keep watching, payment is guaranteed</small>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">
                                                        <i class="iconoir-drone fs-4"></i>
                                                    </div>
                        ...
                        <li class="dropdown topbar-item">
                            <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="dark-ecommerce-index.html#" role="button"
                                ...
                                <img src="assets/images/users/user-nbg1.png"  class="thumb-lg rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end py-0">
                                <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/users/user-nbg1.png"  class="thumb-md rounded-circle">
                                    </div>
                                    <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                        <h6 class="my-0 fw-medium text-dark fs-13"><?php echo htmlspecialchars($username); ?></h6>
                                        <small class="text-muted mb-0">Kshs <?php echo number_format($total_amount_earned, 2); ?></small>
                                    </div><!--end media-body-->
                                </div>
                                ...
                                <a class="dropdown-item" href="withdrawal_form.php"><i class="las la-lock fs-18 me-1 align-text-bottom"></i> Withdraw</a>
                                        ...
                                        <div class="card-body"> 
                                            <div class="row d-flex justify-content-center ">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="mdi mdi-trending-up"></i><?php echo $daily_clicks; ?></span> New Sessions Today</p>  
                                                    <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="mdi mdi-trending-up"></i><?php echo $total_clicks; ?></span> Total Sessions </p>                                           
                                         
                                                </div><!--end col-->
                                                <div class="col-12 col-md-6 align-self-center text-start text-md-end">
                                                  <a href="withdrawal_form.php"><button type="button" class="btn btn-outline-secondary btn-sm px-2 mt-2 mt-md-0 ">Withdraw Funds</button></a>    
                                                </div><!--end col-->
                                            </div><!--end row-->  
                                        </div><!--end card-body--> 
                                    </div><!--end card-->
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        <div class="col text-center">                                                                        
                                                            ...
                                                            <h6 class="text-uppercase text-muted mt-2 m-0">Withdrawable</h6>                
                                                        </div><!--end col-->
                                                    </div> <!-- end row -->
                                                </div><!--end card-body-->
                                            </div> <!--end card-body-->                     
                                        ...
                                        <div class="col-md-6 col-lg-3"> 
                                            <div class="card shadow-none border mb-3 mb-lg-0">
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        <div class="col text-center">                                                                        
                                                            <span class="fs-18 fw-semibold">2000</span>      
                                                            <h6 class="text-uppercase text-muted mt-2 m-0">Withdraw Limit</h6>                
                                                        </div><!--end col-->
                                                    </div> <!-- end row -->
                                                </div><!--end card-body-->
                                            </div> <!--end card-->                     
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        <div class="col text-center">                                                                        
                                                            ...
                                                            <h6 class="text-uppercase text-muted mt-2 m-0">Earner Clicks</h6>                
                                                        </div><!--end col-->
                                                    </div> <!-- end row -->
                                                </div><!--end card-body-->
                                            </div> <!--end card-body-->                     
